...
import { deleteEtimsDocumentAction } from '@/app/(dashboard)/finance/etims/actions'
...
export function EtimsDeleteButton({ docId, invoiceNo, redirectTo }: Props) {
  ...
  function handleDelete() {
    ...
    startTransition(async () => {
      const result = await deleteEtimsDocumentAction(docId)
      if (result.error) {
